...
mvn exec:java -Dexec.mainClass=Main -Dakka.remote.artery.canonical.port=$AKKA_REMOTING_BIND_HOST -Dakka.remote.artery.canonical.port=2551 -Dakka.management.http.port=8558