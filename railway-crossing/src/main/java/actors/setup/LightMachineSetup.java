...
public class LightMachineSetup
  ...
  public static Behavior<Receptionist.Listing> create(String crossingId) {
    return Behaviors.setup(context ->
      new LightMachineSetup(context, crossingId)
    );
  }
  ...
  private LightMachineSetup(
    ...
    ServiceKey<LightMachine.LightMachineCommand> lightMachineServiceKey =
      ServiceKey.create(LightMachine.LightMachineCommand.class, componentName);
    ...
    getContext()
      .getLog()
      .info(
        "LightMachine registered with ServiceKey: {}",
